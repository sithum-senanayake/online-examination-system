...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/exam_admin_profile.css">
    <!--Javascript file location-->
    <script src="js/mainScript.js"></script>

    <title>Exam Admin Profile</title>
...
<!--Exam Admin Profile Content-->

    <!--user details start-->
    <div class="user-details">
        <span> <b>Exam Admin Name :</b> <?php echo $_SESSION['user_name']; ?> </span>
        <a id="editProf" href="update_exam_admin.php?updateid=<?php echo $_SESSION['user_ID']?>"> Edit Profile </a>
    </div>
